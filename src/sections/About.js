    ...
    render () {
        ...
        const skills = (
            mapSkills.map(skill => {
                ...
                return (
                <LoadingBar key={skill.label} label={skill.label} percent={skill.percent} />
                )
            })
        );
        return (
                ...
                <div className="flex row items-flex-start">
                    <div className="flex row content-space-around items-flex-start">
                        <div className="card flex">
                            <Octagon className="square" icon={ICONS.fast} size="50" color="white" />
                            <div>
                                <h2 className="title">Fast</h2>
                                <p className="text">Fast load times and lag free interaction, my highest priority.</p>
                            </div>
                        </div>

                        <div className="card flex">
                            <Octagon className="square" icon={ICONS.phone} size="50" color="white" />
                            <div>
                                <h2 className="title">Responsive</h2>
                                <p className="text">My layouts will work on any device, big or small.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex row content-space-around items-flex-start">
                        <div className="card flex">
                            <Octagon className="square" icon={ICONS.bulb} size="50" color="white" />
                            <div>
                                <h2 className="title">Intuitive</h2>
                                <p className="text">Strong preference for easy to use, intuitive UX/UI.</p>
                            </div>
                        </div>

                        <div className="card flex">
                            <Octagon className="square" icon={ICONS.dynamic} size="50" color="white" />
                            <div>
                                <h2 className="title">Dynamic</h2>
                                <p className="text">Websites don't have to be static, I love making pages come to life.</p>
                            </div>
                        </div>
                    </div>
                </div>
